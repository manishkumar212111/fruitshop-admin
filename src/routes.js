...
const ProductList = React.lazy(() => import('./views/users/productList'));
const AdminProductList = React.lazy(() => import('./views/products/index'));
...
const routes = [
  ...
  { path: "/admin/products", name: 'Admin Products' , component: AdminProductList},
  ...
  // { path: '/blog', exact: true,  name: 'Plans', component: Blogs },
  // { path: '/blog/add', exact: true,  name: 'Add Plans', component: BlogForm },
  // { path: '/blog/:id', exact: true, name: 'Plan Details', component: BlogForm },
